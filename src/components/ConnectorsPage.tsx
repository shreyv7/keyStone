      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-6">
        ...
        <div className={`p-5 rounded-xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 ${
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <h3 className="text-base font-semibold text-slate-900 dark:text-white">Import Lockfiles & SBOMs</h3>
              <p className="text-sm text-slate-600 dark:text-slate-300 mt-1">
                Upload <code>package-lock.json</code>, <code>pnpm-lock.yaml</code>, <code>poetry.lock</code>, or CycloneDX JSON to analyze dependencies.
              </p>
            </div>
          </div>
