          ...
          <div className={`p-6 rounded-xl border flex flex-col gap-5 ${
            ...
            <div className="flex flex-col gap-4 text-sm">
              <div>
                ...
                >
                  <option value="developer">Developer / AppSec (PR Coordination & Breakages)</option>
                  <option value="ciso">CISO / Executive (Financial Blast Radius & SIFI)</option>
                  <option value="maintainer">Maintainer / SRE (Bus Factors & Anomaly Velocity)</option>
                </select>
              </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-base font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span>Multi-Factor Authentication & Cryptographic Keys</span>
              </h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Physical hardware tokens authorized to execute minimum-cut PR merges and freeze circuit breakers.</p>
            </div>
        ...
        <div className={`p-6 rounded-xl border flex flex-col gap-4 ${
          ...
          <div>
            <h3 className="text-base font-semibold text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <span>Active Browser & Console Sessions</span>
            </h3>
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Manage devices currently authenticated into your Keystone workspace.</p>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-base font-semibold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span>Personal CLI Access Tokens (PATs)</span>
              </h3>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">Developer tokens tied directly to Alex Chen's identity for local shell usage.</p>
            </div>
